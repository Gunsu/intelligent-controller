    ...
    public sealed class PathFinder
    {
        ...
        private static void CheckPathEnd(ConnectorInfo source, ConnectorInfo sink, bool showLastLine, List<Point> linePoints)
        {
            if (showLastLine)
            {
                ...
                {
                    case ConnectorOrientation.Left:
                        startPoint = new Point(source.Position.X - PATH_MARGIN, source.Position.Y);
                        break;
                    case ConnectorOrientation.Top:
                        startPoint = new Point(source.Position.X, source.Position.Y - PATH_MARGIN);
                        break;
                    case ConnectorOrientation.Right:
                        startPoint = new Point(source.Position.X + PATH_MARGIN, source.Position.Y);
                        break;
                ...
                {
                    case ConnectorOrientation.Left:
                        endPoint = new Point(sink.Position.X - PATH_MARGIN, sink.Position.Y);
                        break;
                    case ConnectorOrientation.Top:
                        endPoint = new Point(sink.Position.X, sink.Position.Y - PATH_MARGIN);
                        break;
                    case ConnectorOrientation.Right:
                        endPoint = new Point(sink.Position.X + PATH_MARGIN, sink.Position.Y);
                        break;
