...
namespace IC.UI.Infrastructure.Controls
{
    public class RelativePositionPanel : Panel
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            // SDK docu says about publicChildren Property: 'Classes that are derived from Panel 
            // should use this property, instead of the Children property, for public overrides 
